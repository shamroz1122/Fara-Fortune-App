...
<v-flex xs11 class="text-xs-center"><span class="pr-4 subheading tit">Contact</span></v-flex>
</v-toolbar>
    <v-container fluid class="ma-0 pa-0">
        <v-layout row wrap justify-center style="margin-top:20%">
            <v-flex xs6 sm4 md2 lg2>
               <v-btn color="primary" block small round class="buttons">Contact Details</v-btn>
            </v-flex>
            <v-flex xs12 sm11 md11 class="mt-4">
             <span class="subheading font-weight-medium"><v-icon class="pl-4 pr-2 " color="primary">call</v-icon> Phone Number</span><br>
             <span class="pl-5 subheading font-weight-medium">&nbsp;&nbsp;&nbsp;(973) 384-1022</span>
            </v-flex>
            <v-flex xs12 sm11 md11 class="mt-4">
             <span class="subheading font-weight-medium"><v-icon class="pl-4 pr-2 " color="primary">email</v-icon> Email:</span><br>
             <span class="pl-5 subheading font-weight-medium">&nbsp;&nbsp;&nbsp;For new submissions</span><br>
             <span class="pl-5 subheading font-weight-medium" >&nbsp;&nbsp;&nbsp;<span style="text-decoration: underline;">Sales@farafortunes.com</span></span><br>
             <br>
             <span class="pl-5 subheading font-weight-medium">&nbsp;&nbsp;&nbsp;Customer service</span><br>
             <span class="pl-5 subheading font-weight-medium">&nbsp;&nbsp;&nbsp;<span style="text-decoration: underline;">Customerservice@farafortunes.com</span></span><br>
            </v-flex>
            <v-flex xs10 sm6 md4 lg4 class="mt-3">
